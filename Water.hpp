...
class Water: public Pokemon{
    private:
        ...
        std::string m_type = "Water";

    public:
        Water(std::string l_name, int l_hp, int l_attack, int l_defense, int l_speed, std::string l_special_attack, std::string l_special_defense){
            m_name = l_name;
            m_hp = l_hp;
            m_attack = l_attack;
            m_defense = l_defense;
